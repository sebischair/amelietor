        ...
        <div className="amelie-section">
          <Grid>
            <Cell col={7}>
              ...
              <ul className="section-sub-text">
                <li>Our system will automatically show how your decisions are influencing the quality attributes</li>
        ...
        <div className="amelie-section">
          <Grid>
            <Cell col={7}>
              ...
              <Typography variant="subheading">We use the DBpedia ontology to identify architectural topics</Typography>
              <ul className="section-sub-text">
