    ...
    <footer className="mdl-mini-footer">
      <div className="mdl-mini-footer__left-section">
        ...
        <ul className="mdl-mini-footer__link-list">
          ...
          <li>Powered by <Link to="https://github.com/kriasoft/react-static-boilerplate">React Static Boilerplate</Link></li>
        </ul>
      </div>
      <div className="mdl-mini-footer__right-section">
        <ul className="mdl-mini-footer__link-list">
          <li className="mdl-mini-footer--social-btn" style={{ backgroundColor: 'transparent' }}>
            <a href="https://github.com/sebischair/amelietor" role="button" title="GitHub">
